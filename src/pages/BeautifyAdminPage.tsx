...
export const BeautifyAdminPage: React.FC = () => {
  ...
  return (
    <div className="py-8 bg-paper text-editorial min-h-screen">
      <Container>
        {/* Top Header Bar */}
        <div className="bg-studio-surface border border-studio-border rounded-sm p-4 sm:p-6 mb-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="px-3 py-1.5 bg-paper border border-studio-border rounded-sm text-xs font-mono text-editorial-muted hover:text-editorial flex items-center gap-1.5"
            >
            ...
            <button
              ...
              className="px-3 py-1.5 bg-dark text-paper rounded-sm text-xs font-mono font-bold hover:bg-terracotta transition-colors flex items-center gap-1.5"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          {/* Project Switcher */}
          <div className="bg-studio-surface border border-studio-border p-2 rounded-sm space-y-2">
