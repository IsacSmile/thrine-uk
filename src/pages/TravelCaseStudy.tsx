...
export const TravelCaseStudy: React.FC = () => {
  const project = projects.find((p) => p.slug === 'travel') || projects[0];
  ...
  return (
    <article className="py-12 bg-paper text-editorial">
      <Container>
        ...
        <div className="mb-16">
          <BrowserFrame url={project.liveUrl || "https://travelhault.com"} badge="Live Client Platform">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            <section className="space-y-4">
              ...
              <div className="p-4 bg-studio-surface border border-studio-border rounded-sm text-xs text-editorial space-y-2">
                <div className="font-bold uppercase font-mono text-terracotta">Core Friction Points Addressed:</div>
        ...
        {/* Embedded How The System Works Section Pre-selected to Travel */}
        ...
        <div className="mt-20 pt-10 border-t border-studio-border flex flex-col sm:flex-row items-center justify-between gap-6">
          <div>
            <span className="text-xs font-mono text-terracotta uppercase tracking-widest">Next Case Study</span>
            <h3 className="text-xl font-bold text-editorial font-sans">02 / Boutique Bakery Custom Cake System</h3>
          </div>
          <Button href="/work/bakery" variant="secondary" icon={<ArrowRight className="w-4 h-4" />}>
